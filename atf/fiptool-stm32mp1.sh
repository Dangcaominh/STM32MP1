...
FIP_CONFIG="${FIP_CONFIG:-optee-emmc optee-nand optee-nor optee-sdcard optee-programmer-usb opteemin-emmc opteemin-nand opteemin-nor opteemin-sdcard opteemin-programmer-usb}"
...
FIP_DEVICETREE_SUFFIX_ARRAY[optee-emmc]=""
FIP_SEARCH_CONF_ARRAY[optee-emmc]="default:optee"
...
FIP_DEVICETREE_SUFFIX_ARRAY[optee-nand]=""
FIP_SEARCH_CONF_ARRAY[optee-nand]="default:optee"
...
FIP_DEVICETREE_SUFFIX_ARRAY[optee-nor]=""
FIP_SEARCH_CONF_ARRAY[optee-nor]="default:optee"
...
FIP_DEVICETREE_SUFFIX_ARRAY[optee-sdcard]=""
FIP_SEARCH_CONF_ARRAY[optee-sdcard]="default:optee"
FIP_DEVICE_CONF_ARRAY[optee-sdcard]=""
FIP_BL32_CONF_ARRAY[optee-programmer-usb]="optee"
FIP_DEVICETREE_ARRAY[optee-programmer-usb]=" stm32mp157c-ed1 stm32mp157f-ed1 stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 stm32mp135f-dk stm32mp157a-dk1 stm32mp157d-dk1 stm32mp157c-dk2 stm32mp157f-dk2 "
FIP_DEVICETREE_SUFFIX_ARRAY[optee-programmer-usb]=""
FIP_SEARCH_CONF_ARRAY[optee-programmer-usb]="programmer:optee-programmer-usb:optee-programmer"
FIP_DEVICE_CONF_ARRAY[optee-programmer-usb]="usb"
...
FIP_DEVICETREE_SUFFIX_ARRAY[fastboot-emmc]=""
FIP_SEARCH_CONF_ARRAY[fastboot-emmc]="fastboot-emmc:optee-programmer"
FIP_DEVICE_CONF_ARRAY[fastboot-emmc]="optee-programmer-usb"
...
FIP_DEVICETREE_SUFFIX_ARRAY[fastboot-sdcard]=""
FIP_SEARCH_CONF_ARRAY[fastboot-sdcard]="fastboot-sdcard:optee-programmer"
FIP_DEVICE_CONF_ARRAY[fastboot-sdcard]="optee-programmer-usb"
FIP_BL32_CONF_ARRAY[opteemin-emmc]="optee"
FIP_DEVICETREE_ARRAY[opteemin-emmc]=" stm32mp157c-ed1 stm32mp157f-ed1 stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 "
FIP_DEVICETREE_SUFFIX_ARRAY[opteemin-emmc]=""
FIP_SEARCH_CONF_ARRAY[opteemin-emmc]="default:opteemin"
FIP_DEVICE_CONF_ARRAY[opteemin-emmc]=""
FIP_BL32_CONF_ARRAY[opteemin-nand]="optee"
FIP_DEVICETREE_ARRAY[opteemin-nand]=" stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 "
FIP_DEVICETREE_SUFFIX_ARRAY[opteemin-nand]=""
FIP_SEARCH_CONF_ARRAY[opteemin-nand]="default:opteemin"
FIP_DEVICE_CONF_ARRAY[opteemin-nand]=""
FIP_BL32_CONF_ARRAY[opteemin-nor]="optee"
FIP_DEVICETREE_ARRAY[opteemin-nor]=" stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 "
FIP_DEVICETREE_SUFFIX_ARRAY[opteemin-nor]=""
FIP_SEARCH_CONF_ARRAY[opteemin-nor]="default:opteemin"
FIP_DEVICE_CONF_ARRAY[opteemin-nor]=""
FIP_BL32_CONF_ARRAY[opteemin-sdcard]="optee"
FIP_DEVICETREE_ARRAY[opteemin-sdcard]=" stm32mp135f-dk stm32mp157a-dk1 stm32mp157d-dk1 stm32mp157c-dk2 stm32mp157f-dk2 stm32mp157c-ed1 stm32mp157f-ed1 stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 "
FIP_DEVICETREE_SUFFIX_ARRAY[opteemin-sdcard]=""
FIP_SEARCH_CONF_ARRAY[opteemin-sdcard]="default:opteemin"
FIP_DEVICE_CONF_ARRAY[opteemin-sdcard]=""
FIP_BL32_CONF_ARRAY[opteemin-programmer-usb]="optee"
FIP_DEVICETREE_ARRAY[opteemin-programmer-usb]=" stm32mp157c-ed1 stm32mp157f-ed1 stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 stm32mp135f-dk stm32mp157a-dk1 stm32mp157d-dk1 stm32mp157c-dk2 stm32mp157f-dk2 "
FIP_DEVICETREE_SUFFIX_ARRAY[opteemin-programmer-usb]=""
FIP_SEARCH_CONF_ARRAY[opteemin-programmer-usb]="programmer:opteemin-programmer-usb:opteemin-programmer"
FIP_DEVICE_CONF_ARRAY[opteemin-programmer-usb]="usb"
FIP_BL32_CONF_ARRAY[fastboot-opteemin-emmc]="optee"
FIP_DEVICETREE_ARRAY[fastboot-opteemin-emmc]=" stm32mp157c-ed1 stm32mp157f-ed1 stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 "
FIP_DEVICETREE_SUFFIX_ARRAY[fastboot-opteemin-emmc]=""
FIP_SEARCH_CONF_ARRAY[fastboot-opteemin-emmc]="fastboot-emmc:opteemin-programmer"
FIP_DEVICE_CONF_ARRAY[fastboot-opteemin-emmc]="opteemin-emmc"
FIP_BL32_CONF_ARRAY[fastboot-opteemin-sdcard]="optee"
FIP_DEVICETREE_ARRAY[fastboot-opteemin-sdcard]=" stm32mp135f-dk stm32mp157a-dk1 stm32mp157d-dk1 stm32mp157c-dk2 stm32mp157f-dk2 stm32mp157c-ed1 stm32mp157f-ed1 stm32mp157a-ev1 stm32mp157c-ev1 stm32mp157d-ev1 stm32mp157f-ev1 "
FIP_DEVICETREE_SUFFIX_ARRAY[fastboot-opteemin-sdcard]=""
FIP_SEARCH_CONF_ARRAY[fastboot-opteemin-sdcard]="fastboot-sdcard:opteemin-programmer"
FIP_DEVICE_CONF_ARRAY[fastboot-opteemin-sdcard]="opteemin-sdcard"
...
if [ -z "$FIP_CONFIG" ]; then
    ...
    for config in $FIP_CONFIG; do
        CONFIG_FOUND=NO
        for fip_config in  optee-emmc optee-nand optee-nor optee-sdcard optee-programmer-usb fastboot-emmc fastboot-sdcard opteemin-emmc opteemin-nand opteemin-nor opteemin-sdcard opteemin-programmer-usb fastboot-opteemin-emmc fastboot-opteemin-sdcard ; do
            [ "${config}" = "${fip_config}" ] && { CONFIG_FOUND="YES" ; break; }
        done
        [ "${CONFIG_FOUND}" = "NO" ] && bbfatal "Wrong 'FIP_CONFIG' configuration : ${config} is not one of the supported one ( optee-emmc optee-nand optee-nor optee-sdcard optee-programmer-usb fastboot-emmc fastboot-sdcard opteemin-emmc opteemin-nand opteemin-nor opteemin-sdcard opteemin-programmer-usb fastboot-opteemin-emmc fastboot-opteemin-sdcard )"
    done
fi
...
echo ""
echo "fiptool-stm32mp.stm32mp1 config:"
for config in $FIP_CONFIG; do
    i=$(expr $i + 1)
