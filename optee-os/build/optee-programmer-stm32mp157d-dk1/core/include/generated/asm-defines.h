#ifndef _home_dangcaominh_STM32MP1_optee_os_optee_os____build_optee_programmer_stm32mp157d_dk1_core_include_generated_asm_defines_h
#define _home_dangcaominh_STM32MP1_optee_os_optee_os____build_optee_programmer_stm32mp157d_dk1_core_include_generated_asm_defines_h
...
#define THREAD_SCALL_REG_R0	4	/* offsetof(struct thread_scall_regs, r0)"	*/
#define THREAD_SCALL_REG_R5	24	/* offsetof(struct thread_scall_regs, r5)"	*/
#define THREAD_SCALL_REG_R6	28	/* offsetof(struct thread_scall_regs, r6)"	*/
...
#define SM_PM_CTX_SIZE	160	/* sizeof(struct sm_pm_ctx)"	*/
#define THREAD_CTX_SIZE	768	/* sizeof(struct thread_ctx)"	*/
...
#define CORE_MMU_CONFIG_SIZE	24	/* sizeof(struct core_mmu_config)"	*/
#define CORE_MMU_CONFIG_MAP_OFFSET	20	/* offsetof(struct core_mmu_config, map_offset)"	*/
