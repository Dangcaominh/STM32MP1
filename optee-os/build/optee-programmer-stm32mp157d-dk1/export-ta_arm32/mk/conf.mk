...
ta_arm32-platform-cflags := -mcpu=cortex-a7 -Os -g3 -fpic -mthumb -fno-short-enums -fno-common -mno-unaligned-access -mfloat-abi=hard -funsafe-math-optimizations -fstack-protector-strong
ta_arm32-platform-aflags := -pipe -g -mcpu=cortex-a7 -marm
ta_arm32-platform-cxxflags := -fpic -mcpu=cortex-a7 -Os -g3 -mfloat-abi=hard -funsafe-math-optimizations
