...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 209000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32_IPCC_MAILBOX_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_STM32MP1_RCC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32MP157C_DK2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_STM32MP157C_DK2_STM32MP157CXX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_STM32MP1X, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32MP15_M4, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x10000000);
